...
!function(t, e) {
    ...
    var n, o = "alert", a = "bs.alert", l = "." + a, c = g.fn[o], h = {
        CLOSE: "close" + l,
        CLOSED: "closed" + l,
    ...
    n._removeElement = function(e) {
        ...
        g(e).hasClass("fade") ? (t = _.getTransitionDurationFromElement(e),
    ...
    g(document).on(h.CLICK_DATA_API, '[data-dismiss="alert"]', d._handleDismiss(new d)),
    g.fn[o] = d._jQueryInterface,
    g.fn[o].Constructor = d,
    g.fn[o].noConflict = function() {
        return g.fn[o] = c,
        d._jQueryInterface
    }
    ;
    var m, p = "button", v = "bs.button", E = "." + v, y = ".data-api", C = g.fn[p], T = "active", S = '[data-toggle^="button"]', b = ".btn", I = {
        ...
        if (n) {
            ...
            if (o) {
                if ("radio" === o.type && (o.checked && this._element.classList.contains(T) ? t = !1 : (i = n.querySelector(".active")) && g(i).removeClass(T)),
                t) {
    ...
    ;
    var A, N = "carousel", O = "bs.carousel", k = "." + O, P = ".data-api", L = g.fn[N], j = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
    ...
    }, U = "active", W = ".active.carousel-item", q = {
        TOUCH: "touch",
        PEN: "pen"
    ...
    A.pause = function(t) {
        t || (this._isPaused = !0),
        this._element.querySelector(".carousel-item-next, .carousel-item-prev") && (_.triggerTransitionEnd(this._element),
        this.cycle(!0)),
    ...
    A._getConfig = function(t) {
        return t = r({}, j, t),
        _.typeCheckConfig(N, t, H),
        t
    }
    ,
    A._handleSwipe = function() {
        var t, e = Math.abs(this.touchDeltaX);
        e <= 40 || (0 < (t = e / this.touchDeltaX) && this.prev(),
        t < 0 && this.next())
    }
    ,
    ...
    A._addTouchEventListeners = function() {
        ...
        this._pointerEvent ? (g(this._element).on(F.POINTERDOWN, t),
        g(this._element).on(F.POINTERUP, e),
        this._element.classList.add("pointer-event")) : (g(this._element).on(F.TOUCHSTART, t),
    ...
    A._setActiveIndicatorElement = function(t) {
        ...
        g(e).removeClass(U),
        (n = this._indicatorsElement.children[this._getItemIndex(t)]) && g(n).addClass(U))
    }
    ,
    A._slide = function(t, e) {
        var n, i, o, s, r, a = this, l = this._element.querySelector(W), c = this._getItemIndex(l), h = e || l && this._getItemByDirection(t, l), u = this._getItemIndex(h), d = Boolean(this._interval), f = t === R ? (n = "carousel-item-left",
        i = "carousel-item-next",
        "left") : (n = "carousel-item-right",
        i = "carousel-item-prev",
        "right");
        h && g(h).hasClass(U) ? this._isSliding = !1 : !this._triggerSlideEvent(h, f).isDefaultPrevented() && l && h && (this._isSliding = !0,
        d && this.pause(),
        ...
        this._config.interval = s ? (this._config.defaultInterval = this._config.defaultInterval || this._config.interval,
        s) : this._config.defaultInterval || this._config.interval,
        r = _.getTransitionDurationFromElement(l),
        g(l).one(_.TRANSITION_END, function() {
            g(h).removeClass(n + " " + i).addClass(U),
            g(l).removeClass(U + " " + i + " " + n),
            a._isSliding = !1,
            setTimeout(function() {
                return g(a._element).trigger(o)
            }, 0)
        }).emulateTransitionEnd(r)) : (g(l).removeClass(U),
        g(h).addClass(U),
        this._isSliding = !1,
    ...
    K._dataApiClickHandler = function(t) {
        ...
        !o || (e = g(o)[0]) && g(e).hasClass("carousel") && (n = r({}, g(e).data(), g(this).data()),
        (i = this.getAttribute("data-slide-to")) && (n.interval = !1),
        K._jQueryInterface.call(g(e), n),
        i && g(e).data(O).to(i),
        t.preventDefault())
    }
    ,
    ...
    ;
    var Q, B = "collapse", V = "bs.collapse", Y = "." + V, z = g.fn[B], X = {
        toggle: !0,
        parent: ""
    }, $ = {
        toggle: "boolean",
    ...
    }, J = "show", Z = "collapse", tt = "collapsing", et = "collapsed", nt = '[data-toggle="collapse"]', it = ((Q = ot.prototype).toggle = function() {
    ...
    Q.show = function() {
        ...
        t && (e = g(t).not(this._selector).data(V)) && e._isTransitioning) || (n = g.Event(G.SHOW),
        g(this._element).trigger(n),
        n.isDefaultPrevented() || (t && (ot._jQueryInterface.call(g(t).not(this._selector), "hide"),
        e || g(t).data(V, null)),
        i = this._getDimension(),
        g(this._element).removeClass(Z).addClass(tt),
        ...
        g(this._element).one(_.TRANSITION_END, function() {
            g(r._element).removeClass(tt).addClass(Z).addClass(J),
            r._element.style[i] = "",
            r.setTransitioning(!1),
            g(r._element).trigger(G.SHOWN)
    ...
    Q.hide = function() {
        ...
        if (!this._isTransitioning && g(this._element).hasClass(J)) {
            ...
            !e.isDefaultPrevented()) {
                ...
                g(this._element).addClass(tt).removeClass(Z).removeClass(J);
                ...
                g(this._element).one(_.TRANSITION_END, function() {
                    ...
                    g(t._element).removeClass(tt).addClass(Z).trigger(G.HIDDEN)
    ...
    ;
    var st, rt = "dropdown", at = "bs.dropdown", lt = "." + at, ct = ".data-api", ht = g.fn[rt], ut = new RegExp("38|40|27"), dt = {
        HIDE: "hide" + lt,
        HIDDEN: "hidden" + lt,
        SHOW: "show" + lt,
        SHOWN: "shown" + lt,
    ...
    }, ft = "disabled", gt = "show", _t = "dropdown-menu-right", mt = '[data-toggle="dropdown"]', pt = ".dropdown-menu", vt = {
        offset: 0,
        flip: !0,
        ...
        if (!this._element.disabled && !g(this._element).hasClass(ft)) {
            ...
            !e) {
                ...
                !i.isDefaultPrevented()) {
                    ...
                    g(t).toggleClass(gt).trigger(g.Event(dt.SHOWN, n))
                }
            }
        }
    }
    ...
    st.show = function() {
        ...
        g(n).trigger(e),
        e.isDefaultPrevented() || (g(this._menu).toggleClass(gt),
        g(n).toggleClass(gt).trigger(g.Event(dt.SHOWN, t))))
    }
    ,
    st.hide = function() {
        var t, e, n;
        ...
        g(n).trigger(e),
        e.isDefaultPrevented() || (g(this._menu).toggleClass(gt),
        g(n).toggleClass(gt).trigger(g.Event(dt.HIDDEN, t))))
    }
    ,
    st.dispose = function() {
    ...
    st._getConfig = function(t) {
        return t = r({}, this.constructor.Default, g(this._element).data(), t),
    ...
    st._getMenuElement = function() {
        var t;
        return this._menu || (t = Ct._getParentFromElement(this._element)) && (this._menu = t.querySelector(pt)),
        this._menu
    }
    ,
    st._getPlacement = function() {
        ...
        g(this._menu).hasClass(_t) && (e = "top-end")) : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : g(this._menu).hasClass(_t) && (e = "bottom-end"),
        e
    }
    ,
    ...
    Ct._jQueryInterface = function(e) {
        return this.each(function() {
            ...
            if (t || (t = new Ct(this,"object" == typeof e ? e : null),
            g(this).data(at, t)),
            "string" == typeof e) {
                if (void 0 === t[e])
    ...
    Ct._clearMenus = function(t) {
        if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
            for (var e = [].slice.call(document.querySelectorAll(mt)), n = 0, i = e.length; n < i; n++) {
                var o, s, r = Ct._getParentFromElement(e[n]), a = g(e[n]).data(at), l = {
                    relatedTarget: e[n]
                };
                t && "click" === t.type && (l.clickEvent = t),
                a && (o = a._menu,
                !g(r).hasClass(gt) || t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && g.contains(r, t.target) || (s = g.Event(dt.HIDE, l),
                g(r).trigger(s),
                s.isDefaultPrevented() || ("ontouchstart"in document.documentElement && g(document.body).children().off("mouseover", null, g.noop),
                e[n].setAttribute("aria-expanded", "false"),
                g(o).removeClass(gt),
                g(r).removeClass(gt).trigger(g.Event(dt.HIDDEN, l)))))
            }
    }
    ,
    ...
    Ct._dataApiKeydownHandler = function(t) {
        var e, n, i, o, s;
        (/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || g(t.target).closest(pt).length) : !ut.test(t.which)) || (t.preventDefault(),
        t.stopPropagation(),
        this.disabled || g(this).hasClass(ft)) || (e = Ct._getParentFromElement(this),
        (n = g(e).hasClass(gt)) && (!n || 27 !== t.which && 32 !== t.which) ? 0 !== (i = [].slice.call(e.querySelectorAll(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)"))).length && (o = i.indexOf(t.target),
        38 === t.which && 0 < o && o--,
        40 === t.which && o < i.length - 1 && o++,
        o < 0 && (o = 0),
        i[o].focus()) : (27 === t.which && (s = e.querySelector(mt),
        g(s).trigger("focus")),
    ...
    ;
    var Tt, St = "modal", bt = "bs.modal", It = "." + bt, Dt = g.fn[St], wt = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
        show: !0
    ...
    }, Ot = "modal-open", kt = "fade", Pt = "show", Lt = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", jt = ".sticky-top", Ht = ((Tt = Rt.prototype).toggle = function(t) {
        return this._isShown ? this.hide() : this.show(t)
    }
    ,
    Tt.show = function(t) {
        var e, n = this;
        this._isShown || this._isTransitioning || (g(this._element).hasClass(kt) && (this._isTransitioning = !0),
        e = g.Event(Nt.SHOW, {
            relatedTarget: t
        }),
    ...
    Tt.hide = function(t) {
        var e, n, i, o = this;
        t && t.preventDefault(),
        this._isShown && !this._isTransitioning && (e = g.Event(Nt.HIDE),
        g(this._element).trigger(e),
        this._isShown && !e.isDefaultPrevented() && (this._isShown = !1,
        (n = g(this._element).hasClass(kt)) && (this._isTransitioning = !0),
        this._setEscapeEvent(),
        this._setResizeEvent(),
        ...
        n ? (i = _.getTransitionDurationFromElement(this._element),
    ...
    Tt._showElement = function(t) {
        ...
        n ? (o = _.getTransitionDurationFromElement(this._dialog),
        g(this._dialog).one(_.TRANSITION_END, i).emulateTransitionEnd(o)) : i()
    }
    ,
    ...
    Tt._showBackdrop = function(t) {
        var e, n, i = this, o = g(this._element).hasClass(kt) ? kt : "";
        if (this._isShown && this._config.backdrop) {
            ...
            !this._isShown && this._backdrop ? (g(this._backdrop).removeClass(Pt),
            e = function() {
                i._removeBackdrop(),
                t && t()
            }
            ,
            g(this._element).hasClass(kt) ? (n = _.getTransitionDurationFromElement(this._backdrop),
            g(this._backdrop).one(_.TRANSITION_END, e).emulateTransitionEnd(n)) : e()) : t && t()
    }
    ,
    ...
    Tt._setScrollbar = function() {
        var t, e, n, i, o = this;
        this._isBodyOverflowing && (t = [].slice.call(document.querySelectorAll(Lt)),
    ...
    function Wt(t, r, e) {
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(r), l = [].slice.call(n.body.querySelectorAll("*")), i = function(t, e) {
            ...
            o.forEach(function(t) {
                !function(t, e) {
                    var n = t.nodeName.toLowerCase();
                    if (-1 !== e.indexOf(n))
                        return -1 === xt.indexOf(n) || Boolean(t.nodeValue.match(Ft) || t.nodeValue.match(Ut));
        ...
        }, o = 0, s = l.length; o < s; o++)
            i(o);
        return n.body.innerHTML
    }
    var qt, Mt = "tooltip", Kt = "bs.tooltip", Qt = "." + Kt, Bt = g.fn[Mt], Vt = "bs-tooltip", Yt = new RegExp("(^|\\s)" + Vt + "\\S+","g"), zt = ["sanitize", "whiteList", "sanitizeFn"], Xt = {
        animation: "boolean",
        template: "string",
    ...
    }, te = "fade", ee = "show", ne = "hover", ie = "focus", oe = ((qt = se.prototype).enable = function() {
        this._isEnabled = !0
    }
    ,
    qt.disable = function() {
    ...
    qt.show = function() {
        ...
        if (this.isWithContent() && this._isEnabled) {
            ...
            g(this.tip).hasClass(te) ? (c = _.getTransitionDurationFromElement(this.tip),
            g(this.tip).one(_.TRANSITION_END, h).emulateTransitionEnd(c)) : h()
        }
    }
    ,
    qt.hide = function(t) {
        function e() {
            i._hoverState !== Jt && o.parentNode && o.parentNode.removeChild(o),
            i._cleanTipClass(),
        ...
        s.isDefaultPrevented() || (g(o).removeClass(ee),
        "ontouchstart"in document.documentElement && g(document.body).children().off("mouseover", null, g.noop),
        this._activeTrigger.click = !1,
        this._activeTrigger[ie] = !1,
        this._activeTrigger[ne] = !1,
        g(this.tip).hasClass(te) ? (n = _.getTransitionDurationFromElement(o),
        g(o).one(_.TRANSITION_END, e).emulateTransitionEnd(n)) : e(),
        this._hoverState = "")
    }
    ,
    qt.update = function() {
    ...
    qt.setElementContent = function(t, e) {
        "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Wt(e, this.config.whiteList, this.config.sanitizeFn)),
    ...
    qt._setListeners = function() {
        ...
        this.config.trigger.split(" ").forEach(function(t) {
            ...
            "click" === t ? g(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) {
                return i.toggle(t)
            }) : "manual" !== t && (e = t === ne ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
    ...
    qt._enter = function(t, e) {
        ...
        g(e.getTipElement()).hasClass(ee) || e._hoverState === Jt ? e._hoverState = Jt : (clearTimeout(e._timeout),
        e._hoverState = Jt,
    ...
    qt._fixTransition = function() {
        ...
        null === t.getAttribute("x-placement") && (g(t).removeClass(te),
    ...
    se._jQueryInterface = function(n) {
        return this.each(function() {
            var t = g(this).data(Kt)
              , e = "object" == typeof n && n;
            if ((t || !/dispose|hide/.test(n)) && (t || (t = new se(this,e),
            g(this).data(Kt, t)),
            "string" == typeof n)) {
                if (void 0 === t[n])
                    throw new TypeError('No method named "' + n + '"');
    ...
    ;
    var me, pe = "scrollspy", ve = "bs.scrollspy", Ee = "." + ve, ye = g.fn[pe], Ce = {
        offset: 10,
        method: "auto",
        target: ""
    }, Te = {
    ...
    }, be = "active", Ie = ".nav, .list-group", De = ".nav-link", we = ".list-group-item", Ae = "position", Ne = ((me = Oe.prototype).refresh = function() {
        var e = this
    ...
    me._getConfig = function(t) {
        var e;
        return "string" != typeof (t = r({}, Ce, "object" == typeof t && t ? t : {})).target && ((e = g(t.target).attr("id")) || (e = _.getUID(pe),
        g(t.target).attr("id", e)),
        t.target = "#" + e),
        _.typeCheckConfig(pe, t, Te),
        t
    }
    ,
    ...
    me._activate = function(e) {
        ...
        n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(be),
        n.addClass(be)) : (n.addClass(be),
        n.parents(Ie).prev(De + ", " + we).addClass(be),
    ...
    Oe._jQueryInterface = function(e) {
        return this.each(function() {
            ...
            if (t || (t = new Oe(this,"object" == typeof e && e),
            g(this).data(ve, t)),
            "string" == typeof e) {
                if (void 0 === t[e])
                    throw new TypeError('No method named "' + e + '"');
    ...
    ;
    var ke, Pe = "bs.tab", Le = "." + Pe, je = g.fn.tab, He = {
        HIDE: "hide" + Le,
        HIDDEN: "hidden" + Le,
        SHOW: "show" + Le,
        SHOWN: "shown" + Le,
        CLICK_DATA_API: "click" + Le + ".data-api"
    }, Re = "active", xe = ".active", Fe = "> li > .active", Ue = ((ke = We.prototype).show = function() {
        var t, e, n, i, o, s, r, a, l = this;
        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && g(this._element).hasClass(Re) || g(this._element).hasClass("disabled") || (e = g(this._element).closest(".nav, .list-group")[0],
        n = _.getSelectorFromElement(this._element),
        e && (i = "UL" === e.nodeName || "OL" === e.nodeName ? Fe : xe,
    ...
    ke._activate = function(t, e, n) {
        ...
        var o, s = this, r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? g(e).children(xe) : g(e).find(Fe))[0], a = n && r && g(r).hasClass("fade");
        r && a ? (o = _.getTransitionDurationFromElement(r),
        g(r).removeClass("show").one(_.TRANSITION_END, i).emulateTransitionEnd(o)) : i()
    }
    ,
    ke._transitionComplete = function(t, e, n) {
        var i, o, s;
        e && (g(e).removeClass(Re),
        (i = g(e.parentNode).find("> .dropdown-menu .active")[0]) && g(i).removeClass(Re),
    ...
    g(document).on(He.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        Ue._jQueryInterface.call(g(this), "show")
    }),
    ...
    ;
    var qe, Me = "toast", Ke = "bs.toast", Qe = "." + Ke, Be = g.fn[Me], Ve = {
        CLICK_DISMISS: "click.dismiss" + Qe,
        HIDE: "hide" + Qe,
        HIDDEN: "hidden" + Qe,
        SHOW: "show" + Qe,
        SHOWN: "shown" + Qe
    }, Ye = "show", ze = "showing", Xe = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, $e = {
        ...
        this._config.animation ? (t = _.getTransitionDurationFromElement(this._element),
        g(this._element).one(_.TRANSITION_END, n).emulateTransitionEnd(t)) : n()
    }
    ,
    qe.hide = function(t) {
        var e = this;
        this._element.classList.contains(Ye) && (g(this._element).trigger(Ve.HIDE),
    ...
    qe._getConfig = function(t) {
        return t = r({}, $e, g(this._element).data(), "object" == typeof t && t ? t : {}),
    ...
    qe._close = function() {
        function t() {
            ...
            g(n._element).trigger(Ve.HIDDEN)
        }
        var e, n = this;
        this._element.classList.remove(Ye),
        this._config.animation ? (e = _.getTransitionDurationFromElement(this._element),
        g(this._element).one(_.TRANSITION_END, t).emulateTransitionEnd(e)) : t()
    }
    ,
    Je._jQueryInterface = function(n) {
        return this.each(function() {
            var t = g(this)
              , e = t.data(Ke);
            if (e || (e = new Je(this,"object" == typeof n && n),
            t.data(Ke, e)),
            "string" == typeof n) {
                if (void 0 === e[n])
                    throw new TypeError('No method named "' + n + '"');
    ...
    r.prototype = {
        ...
        init: function() {
            ...
            s.timeout = setTimeout(function() {
                for (var t = 0; t < s.strings.length; ++t)
                    s.sequence[t] = t;
        ...
        build: function() {
            var s = this;
            !0 === this.showCursor && (this.cursor = e.createElement("span"),
        ...
        typewrite: function(r, n) {
            var t, a;
            !0 !== this.stop && (this.fadeOut && this.el.classList.contains(this.fadeOutClass) && (this.el.classList.remove(this.fadeOutClass),
            this.cursor.classList.remove(this.fadeOutClass)),
            t = Math.round(70 * Math.random()) + this.typeSpeed,
            (a = this).timeout = setTimeout(function() {
                var t, s = 0, e = r.substr(n);
                if ("^" === e.charAt(0) && (t = 1,
                /^\^\d+/.test(e) && (t += (e = /\d+/.exec(e)[0]).length,
                s = parseInt(e)),
                r = r.substring(0, n) + r.substring(n + t)),
                "html" === a.contentType) {
                    var i = r.substr(n).charAt(0);
                    if ("<" === i || "&" === i) {
                        for (var o = "", o = "<" === i ? ">" : ";"; r.substr(n + 1).charAt(0) !== o && (r.substr(n).charAt(0),
                        !(++n + 1 > r.length)); )
                            ;
                        n++,
                        0
                ...
                a.timeout = setTimeout(function() {
                    if (n === r.length) {
                        ...
                        a.attr ? a.el.setAttribute(a.attr, t) : a.isInput ? a.el.value = t : "html" === a.contentType ? a.el.innerHTML = t : a.el.textContent = t,
                        n++,
                        a.typewrite(r, n)
                    }
                }, s)
        ...
        backspace: function(s, e) {
            var t, i = this;
            !0 !== this.stop && (this.fadeOut ? this.initFadeOut() : (t = Math.round(70 * Math.random()) + this.backSpeed,
            i.timeout = setTimeout(function() {
                if ("html" === i.contentType && ">" === s.substr(e).charAt(0)) {
                    for (; "<" !== s.substr(e - 1).charAt(0) && (s.substr(e).charAt(0),
                    !(--e < 0)); )
                        ;
                    e--,
                    0
                ...
                i.replaceText(t),
                e > i.stopNum ? (e--,
                i.backspace(s, e)) : e <= i.stopNum && (i.arrayPos++,
                i.arrayPos === i.strings.length ? (i.arrayPos = 0,
                i.shuffle && (i.sequence = i.shuffleArray(i.sequence)),
                i.init()) : i.typewrite(i.strings[i.sequence[i.arrayPos]], e))
            }, t)))
        },
...
!function(t) {
    ...
    x.Widget.prototype = {
        ...
        _on: function(a, r, t) {
            ...
            x.each(t, function(t, e) {
                function i() {
                    if (a || !0 !== l.options.disabled && !x(this).hasClass("ui-state-disabled"))
    ...
    x.position = {
        scrollbarWidth: function() {
            if (void 0 !== o)
                return o;
            var t, e, i = x("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"), s = i.children()[0];
    ...
    x.fn.position = function(u) {
        ...
        u = x.extend({}, u);
        var d, p, f, g, m, t, e, _ = x(u.of), v = x.position.getWithinInfo(u.within), b = x.position.getScrollInfo(v), y = (u.collision || "flip").split(" "), w = {}, i = 9 === (e = (t = _)[0]).nodeType ? {
            width: t.width(),
            height: t.height(),
            offset: {
                top: 0,
        ...
        m.top += d[1],
        this.each(function() {
            var i, t, a = x(this), r = a.outerWidth(), h = a.outerHeight(), e = T(this, "marginLeft"), s = T(this, "marginTop"), n = r + e + T(this, "marginRight") + b.width, o = h + s + T(this, "marginBottom") + b.height, l = x.extend({}, m), c = I(w.my, a.outerWidth(), a.outerHeight());
            ...
            u.using && (t = function(t) {
                ...
                k(C(e), C(i)) > k(C(s), C(n)) ? o.important = "horizontal" : o.important = "vertical",
    ...
    x.ui.position = {
        fit: {
            left: function(t, e) {
                ...
                e.collisionWidth > o ? 0 < r && h <= 0 ? (i = t.left + r + e.collisionWidth - o - n,
                t.left += r - i) : t.left = !(0 < h && r <= 0) && h < r ? n + o - e.collisionWidth : n : 0 < r ? t.left += r : 0 < h ? t.left -= h : t.left = k(t.left - a, t.left)
            },
            top: function(t, e) {
                ...
                e.collisionHeight > o ? 0 < r && h <= 0 ? (i = t.top + r + e.collisionHeight - o - n,
                t.top += r - i) : t.top = !(0 < h && r <= 0) && h < r ? n + o - e.collisionHeight : n : 0 < r ? t.top += r : 0 < h ? t.top -= h : t.top = k(t.top - a, t.top)
            }
        },
        flip: {
            left: function(t, e) {
                var i, s, n = e.within, o = n.offset.left + n.scrollLeft, a = n.width, r = n.isWindow ? n.scrollLeft : n.offset.left, h = t.left - e.collisionPosition.marginLeft, l = h - r, c = h + e.collisionWidth - a - r, u = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0, d = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0] ? -e.targetWidth : 0, p = -2 * e.offset[0];
            ...
            top: function(t, e) {
                var i, s, n = e.within, o = n.offset.top + n.scrollTop, a = n.height, r = n.isWindow ? n.scrollTop : n.offset.top, h = t.top - e.collisionPosition.marginTop, l = h - r, c = h + e.collisionHeight - a - r, u = "top" === e.my[1] ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0, d = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0, p = -2 * e.offset[1];
    ...
    var t, u, d, p, f, e, g, m, _, v, b, y, w, P, M, S, H, z, O, A, N, W, E = "ui-effects-", F = "ui-effects-style", L = "ui-effects-animated", R = x;
    function B(t, e, i) {
        var s = _[e.type] || {};
    ...
    function Y(a) {
        ...
        y(e, function(t, e) {
            ...
            if (n)
                return i = r[o](n),
                r[m[o].cache] = i[m[o].cache],
                h = r._rgba = i._rgba,
                !1
        }),
        h.length ? ("0,0,0,0" === h.join() && u.extend(h, p.transparent),
        r) : p[a]
    }
    function j(t, e, i) {
    ...
    v.rgba = -1 < b.style.backgroundColor.indexOf("rgba"),
    y(m, function(t, e) {
        e.cache = "_" + t,
        e.props.alpha = {
            idx: 3,
    ...
    g.fn = u.extend(g.prototype, {
        parse: function(n, t, e, i) {
            ...
            s = "array"),
            "string" === s ? this.parse(Y(n) || p._default) : "array" === s ? (y(m.rgba.props, function(t, e) {
                a[e.idx] = B(n[e.idx], e)
            }),
            ...
            : function(t, i) {
                ...
                o[s] && u.inArray(null, o[s].slice(0, 3)) < 0 && (o[s][3] = 1,
    ...
    y(m, function(h, t) {
        ...
        g.fn[h] = function(t) {
            ...
            t === d)
                return this[a].slice();
            var e, s = u.type(t), n = "array" === s || "object" === s ? t : arguments, o = this[a].slice();
        ...
        y(i, function(a, r) {
            g.fn[a] || (g.fn[a] = function(t) {
                var e, i = u.type(t), s = "alpha" === a ? this._hsla ? "hsla" : "rgba" : h, n = this[s](), o = n[r.idx];
        ...
        return this.queue(function() {
            ...
            s = s.map(function() {
                ...
                this.diff = function(t, e) {
                    ...
                    for (i in e)
                        s = e[i],
                        t[i] !== s && (H[i] || !x.fx.step[i] && isNaN(parseFloat(s)) || (n[i] = s));
                    return n
                }(this.start, this.end),
                this
            }),
    ...
    x.fn.extend({
        ...
        removeClass: (P = x.fn.removeClass,
        function(t, e, i, s) {
        ...
        toggleClass: (w = x.fn.toggleClass,
        function(t, e, i, s, n) {
    ...
    x.expr && x.expr.filters && x.expr.filters.animated && (x.expr.filters.animated = (z = x.expr.filters.animated,
    function(t) {
    ...
    x.fn.extend({
        effect: function() {
            ...
            var s = K.apply(this, arguments)
              ...
              , h = [];
            if (x.fx.off || !n)
                return r ? this[r](s.duration, a) : this.each(function() {
                    a && a.call(this)
                });
            function l(t) {
                var e = x(this);
    ...
    x.effects.define("bounce", function(t, e) {
        var i, s, n, o = x(this), a = t.mode, r = "hide" === a, h = "show" === a, l = t.direction || "up", c = t.distance, u = t.times || 5, d = 2 * u + (h || r ? 1 : 0), p = t.duration / d, f = t.easing, g = "up" === l || "down" === l ? "top" : "left", m = "up" === l || "left" === l, _ = 0, v = o.queue().length;
        ...
        o.css("opacity", 0).css(g, m ? 2 * -c : 2 * c).animate(s, p, f)),
        r && (c /= Math.pow(2, u - 1)),
        (s = {})[g] = n; _ < u; _++)
            (i = {})[g] = (m ? "-=" : "+=") + c,
    ...
    x.effects.define("drop", "hide", function(t, e) {
        var i, s = x(this), n = "show" === t.mode, o = t.direction || "left", a = "up" === o || "down" === o ? "top" : "left", r = "up" === o || "left" === o ? "-=" : "+=", h = "+=" == r ? "-=" : "+=", l = {
            opacity: 0
        };
        x.effects.createPlaceholder(s),
    ...
    x.effects.define("explode", "hide", function(t, e) {
        var i, s, n, o, a, r, h = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, l = h, c = x(this), u = "show" === t.mode, d = c.show().css("visibility", "hidden").offset(), p = Math.ceil(c.outerWidth() / l), f = Math.ceil(c.outerHeight() / h), g = [];
        function m() {
            g.push(this),
            g.length === h * l && (c.css({
                visibility: "visible"
    ...
    x.effects.define("fold", "hide", function(e, t) {
        ...
        p.clip = u),
        i.queue(function(t) {
            c && c.animate(x.effects.clipToBox(d), l, e.easing).animate(x.effects.clipToBox(p), l, e.easing),
            t()
    ...
    x.effects.define("size", function(n, e) {
        ...
        "box" !== u && "both" !== u || (o.from.y !== o.to.y && (m = x.effects.setTransition(s, r, o.from.y, m),
        _ = x.effects.setTransition(s, r, o.to.y, _)),
        o.from.x !== o.to.x && (m = x.effects.setTransition(s, h, o.from.x, m),
        _ = x.effects.setTransition(s, h, o.to.x, _))),
        "content" !== u && "both" !== u || o.from.y !== o.to.y && (m = x.effects.setTransition(s, a, o.from.y, m),
        ...
        s.css(m),
        "content" !== u && "both" !== u || (r = r.concat(["marginTop", "marginBottom"]).concat(a),
        ...
        s.find("*[width]").each(function() {
            ...
            o.from.y !== o.to.y && (i = x.effects.setTransition(t, r, o.from.y, i),
            s = x.effects.setTransition(t, r, o.to.y, s)),
            o.from.x !== o.to.x && (i = x.effects.setTransition(t, h, o.from.x, i),
    ...
    x.ui.focusable = function(t, e) {
        ...
        !(!t.href || !s || "map" !== i.nodeName.toLowerCase()) && (0 < (n = x("img[usemap='#" + s + "']")).length && n.is(":visible"))) : (/^(input|select|textarea|button|object)$/.test(r) ? (o = !t.disabled) && (a = x(t).closest("fieldset")[0]) && (o = !a.disabled) : o = "a" === r && t.href || e,
    ...
    x.widget("ui.accordion", {
        ...
        _eventHandler: function(t) {
            var e, i, s = this.options, n = this.active, o = x(t.currentTarget), a = o[0] === n[0], r = a && s.collapsible, h = r ? x() : o.next(), l = n.next(), c = {
                oldHeader: n,
                oldPanel: l,
                newHeader: r ? x() : o,
                newPanel: h
            ...
            t.preventDefault(),
            a && !s.collapsible || !1 === this._trigger("beforeActivate", t, c) || (s.active = !r && this.headers.index(o),
            this.active = a ? x() : o,
            this._toggle(c),
            ...
            a || (this._removeClass(o, "ui-accordion-header-collapsed")._addClass(o, "ui-accordion-header-active", "ui-state-active"),
        ...
        _animate: function(t, i, e) {
            ...
            var n, o, a, r = this, h = 0, l = t.css("box-sizing"), c = t.length && (!i.length || t.index() < i.index()), u = this.options.animate || {}, d = c && u.down || u;
            ...
            void t.hide().animate(this.showProps, {
                ...
                step: function(t, e) {
                    e.now = Math.round(t),
                    "height" !== e.prop ? "content-box" === l && (h += e.now) : "content" !== r.options.heightStyle && (e.now = Math.round(n - i.outerHeight() - h),
                    h = 0)
                }
    ...
    x.widget("ui.menu", {
        ...
        _keydown: function(t) {
            ...
            default:
                ...
                n = !1,
                s = 96 <= t.keyCode && t.keyCode <= 105 ? (t.keyCode - 96).toString() : String.fromCharCode(t.keyCode),
        ...
        refresh: function() {
            ...
            e = a.filter(":not(.ui-menu)").hide().attr({
                role: this.options.role,
                "aria-hidden": "true",
                "aria-expanded": "false"
            }).each(function() {
        ...
        _create: function() {
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function(t, e) {
                    ...
                    (i = e.item.attr("aria-label") || s.value) && x.trim(i).length && (this.liveRegion.children().hide(),
        ...
        _initWidgets: function() {
            ...
            x.each(this.options.items, function(n, t) {
                ...
                if (t)
                    ...
                    void (r = r.concat(e.get()))) : void (x.fn[n] && (o = a["_" + n + "Options"] ? a["_" + n + "Options"]("middle") : {
                        classes: {}
                    },
                    a.element.find(t).each(function() {
                        var t, e = x(this), i = e[n]("instance"), s = x.widget.extend({}, o);
                        "button" === n && e.parent(".ui-spinner").length || ((i = i || e[n]()[n]("instance")) && (s.classes = a._resolveClassesValues(s.classes, i)),
                        e[n](s),
                        t = e[n]("widget"),
                        x.data(t[0], "ui-controlgroup-data", i || e[n]("instance")),
                        r.push(t[0]))
                    })))
            }),
    ...
    function Z() {
        ...
        this.dpDiv = tt(x("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
    }
    function tt(t) {
    ...
    function et() {
        x.datepicker._isDisabledDatepicker(J.inline ? J.dpDiv.parent()[0] : J.input[0]) || (x(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),
    ...
    x.extend(Z.prototype, {
        ...
        _enableDatepicker: function(e) {
            var t, i, s = x(e), n = x.data(e, "datepicker");
        ...
        _optionDatepicker: function(t, e, i) {
            ...
            if (2 === arguments.length && "string" == typeof e)
                return "defaults" === e ? x.extend({}, x.datepicker._defaults) : r ? "all" === e ? x.extend({}, r.settings) : this._get(r, e) : null;
            s = e || {},
        ...
        _doKeyDown: function(t) {
            var e, i, s, n = x.datepicker._getInst(t.target), o = !0, a = n.dpDiv.is(".ui-datepicker-rtl");
            if (n._keyEvent = !0,
            x.datepicker._datepickerShowing)
                ...
                case 9:
                    ...
                    break;
                case 13:
                    return (s = x("td." + x.datepicker._dayOverClass + ":not(." + x.datepicker._currentClass + ")", n.dpDiv))[0] && x.datepicker._selectDay(t.target, n.selectedMonth, n.selectedYear, s[0]),
                    (e = x.datepicker._get(n, "onSelect")) ? (i = x.datepicker._formatDate(n),
                    e.apply(n.input ? n.input[0] : null, [i, n])) : x.datepicker._hideDatepicker(),
                    !1;
                case 27:
                    x.datepicker._hideDatepicker();
                    break;
                ...
                case 36:
                    ...
                    break;
                case 37:
                    (t.ctrlKey || t.metaKey) && x.datepicker._adjustDate(t.target, a ? 1 : -1, "D"),
                    o = t.ctrlKey || t.metaKey,
                    t.originalEvent.altKey && x.datepicker._adjustDate(t.target, t.ctrlKey ? -x.datepicker._get(n, "stepBigMonths") : -x.datepicker._get(n, "stepMonths"), "M");
                    break;
                case 38:
        ...
        _doKeyPress: function(t) {
            ...
            if (x.datepicker._get(s, "constrainInput"))
                return e = x.datepicker._possibleChars(x.datepicker._get(s, "dateFormat")),
        ...
        _showDatepicker: function(t) {
            ...
            x.datepicker._isDisabledDatepicker(t) || x.datepicker._lastInput === t || (r = x.datepicker._getInst(t),
            x.datepicker._curInst && x.datepicker._curInst !== r && (x.datepicker._curInst.dpDiv.stop(!0, !0),
            r && x.datepicker._datepickerShowing && x.datepicker._hideDatepicker(x.datepicker._curInst.input[0])),
            !1 !== (i = (e = x.datepicker._get(r, "beforeShow")) ? e.apply(t, [t, r]) : {}) && (it(r.settings, i),
            r.lastVal = null,
            x.datepicker._lastInput = t,
            x.datepicker._setDateFromField(r),
            ...
            x.datepicker._updateDatepicker(r),
            n = x.datepicker._checkOffset(r, n, s),
            r.dpDiv.css({
            ...
            r.inline || (o = x.datepicker._get(r, "showAnim"),
            a = x.datepicker._get(r, "duration"),
            r.dpDiv.css("z-index", function(t) {
            ...
            x.effects && x.effects.effect[o] ? r.dpDiv.show(o, x.datepicker._get(r, "showOptions"), a) : r.dpDiv[o || "show"](o ? a : null),
            x.datepicker._shouldFocusInput(r) && r.input.trigger("focus"),
            x.datepicker._curInst = r)))
        },
        ...
        _checkOffset: function(t, e, i) {
            ...
            e.top -= i && e.top === t.input.offset().top + a ? x(document).scrollTop() : 0,
            e.left -= Math.min(e.left, e.left + s > r && s < r ? Math.abs(e.left + s - r) : 0),
            e.top -= Math.min(e.top, e.top + n > h && n < h ? Math.abs(n + a) : 0),
            e
        },
        _findPos: function(t) {
            for (var e, i = this._getInst(t), s = this._get(i, "isRTL"); t && ("hidden" === t.type || 1 !== t.nodeType || x.expr.filters.hidden(t)); )
        ...
        _hideDatepicker: function(t) {
            ...
            ,
            x.effects && (x.effects.effect[e] || x.effects[e]) ? o.dpDiv.hide(e, x.datepicker._get(o, "showOptions"), i, s) : o.dpDiv["slideDown" === e ? "slideUp" : "fadeIn" === e ? "fadeOut" : "hide"](e ? i : null, s),
            e || s(),
            this._datepickerShowing = !1,
        ...
        _checkExternalClick: function(t) {
            var e, i;
            x.datepicker._curInst && (e = x(t.target),
        ...
        _selectDay: function(t, e, i, s) {
            var n, o = x(t);
            x(s).hasClass(this._unselectableClass) || this._isDisabledDatepicker(o[0]) || ((n = this._getInst(o[0])).selectedDay = n.currentDay = x("a", s).html(),
        ...
        _selectDate: function(t, e) {
            var i, s = x(t), n = this._getInst(s[0]);
        ...
        parseDate: function(i, o, t) {
            ...
            function s(t, e, i) {
                ...
                if (x.each(n, function(t, e) {
                    var i = e[1];
                    if (o.substr(c, i.length).toLowerCase() === i.toLowerCase())
                        return s = e[0],
                        c += i.length,
                        !1
                }),
            ...
            for (var r, h, l, c = 0, u = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff, d = "string" != typeof u ? u : (new Date).getFullYear() % 100 + parseInt(u, 10), p = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, f = (t ? t.dayNames : null) || this._defaults.dayNames, g = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, m = (t ? t.monthNames : null) || this._defaults.monthNames, _ = -1, v = -1, b = -1, y = -1, w = !1, k = 0; k < i.length; k++)
                if (w)
                    ...
                    case "y":
                        ...
                        break;
                    case "@":
                        _ = (l = new Date(e("@"))).getFullYear(),
                        v = l.getMonth() + 1,
                        b = l.getDate();
                        break;
                    case "!":
                        _ = (l = new Date((e("!") - this._ticksTo1970) / 1e4)).getFullYear(),
                        v = l.getMonth() + 1,
                        b = l.getDate();
                        break;
                    case "'":
            ...
            if (c < o.length && (h = o.substr(c),
            !/^\s+/.test(h)))
                throw "Extra/unparsed characters found in date: " + h;
            if (-1 === _ ? _ = (new Date).getFullYear() : _ < 100 && (_ += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (_ <= d ? 0 : -100)),
            -1 < y)
                for (v = 1,
                b = y; ; ) {
                    if (b <= (r = this._getDaysInMonth(_, v - 1)))
                        break;
                    v++,
                    b -= r
                }
            if ((l = this._daylightSavingAdjust(new Date(_,v - 1,b))).getFullYear() !== _ || l.getMonth() + 1 !== v || l.getDate() !== b)
                throw "Invalid date";
            return l
        },
        ATOM: "yy-mm-dd",
        ...
        formatDate: function(i, t, e) {
            ...
            var a, r = (e ? e.dayNamesShort : null) || this._defaults.dayNamesShort, h = (e ? e.dayNames : null) || this._defaults.dayNames, l = (e ? e.monthNamesShort : null) || this._defaults.monthNamesShort, c = (e ? e.monthNames : null) || this._defaults.monthNames, u = "", d = !1;
            if (t)
        ...
        _generateHTML: function(t) {
            ...
            k = 0; k < U[0]; k++) {
                ...
                C = 0; C < U[1]; C++) {
                    ...
                    for (T += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + I + "'>" + (/all|left/.test(I) && 0 === k ? Y ? o : s : "") + (/all|right/.test(I) && 0 === k ? Y ? s : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, 0 < k || 0 < C, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>",
                    P = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "",
                    w = 0; w < 7; w++)
                        P += "<th scope='col'" + (5 <= (w + c + 6) % 7 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[M = (w + c) % 7] + "'>" + p[M] + "</span></th>";
                    ...
                    N = 0; N < O; N++) {
                        ...
                        w = 0; w < 7; w++)
                            ...
                            L = (F = A.getMonth() !== Z) && !v || !E[0] || Q && A < Q || J && J < A,
                            W += "<td class='" + (5 <= (w + c + 6) % 7 ? " ui-datepicker-week-end" : "") + (F ? " ui-datepicker-other-month" : "") + (A.getTime() === D.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === A.getTime() && b.getTime() === D.getTime() ? " " + this._dayOverClass : "") + (L ? " " + this._unselectableClass + " ui-state-disabled" : "") + (F && !_ ? "" : " " + E[1] + (A.getTime() === G.getTime() ? " " + this._currentClass : "") + (A.getTime() === B.getTime() ? " ui-datepicker-today" : "")) + "'" + (F && !_ || !E[2] ? "" : " title='" + E[2].replace(/'/g, "&#39;") + "'") + (L ? "" : " data-handler='selectDay' data-event='click' data-month='" + A.getMonth() + "' data-year='" + A.getFullYear() + "'") + ">" + (F && !_ ? "&#xa0;" : L ? "<span class='ui-state-default'>" + A.getDate() + "</span>" : "<a class='ui-state-default" + (A.getTime() === B.getTime() ? " ui-state-highlight" : "") + (A.getTime() === G.getTime() ? " ui-state-active" : "") + (F ? " ui-priority-secondary" : "") + "' href='#'>" + A.getDate() + "</a>") + "</td>",
                    ...
                    11 < ++Z && (Z = 0,
                    tt++),
                    x += T += "</tbody></table>" + (X ? "</div>" + (0 < U[0] && C === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                }
                y += x
            }
            return y += l,
    ...
    x.widget("ui.draggable", x.ui.mouse, {
        ...
        _generatePosition: function(t, e) {
            ...
            l = !i || n - this.offset.click.top >= i[1] || n - this.offset.click.top > i[3] ? n : n - this.offset.click.top >= i[1] ? n - a.grid[1] : n + a.grid[1],
            o = a.grid[0] ? this.originalPageX + Math.round((h - this.originalPageX) / a.grid[0]) * a.grid[0] : this.originalPageX,
            h = !i || o - this.offset.click.left >= i[0] || o - this.offset.click.left > i[2] ? o : o - this.offset.click.left >= i[0] ? o - a.grid[0] : o + a.grid[0]),
    ...
    x.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(t, e, i) {
            ...
            s.axis && "y" === s.axis || (t.pageX - x(a).scrollLeft() < s.scrollSensitivity ? n = x(a).scrollLeft(x(a).scrollLeft() - s.scrollSpeed) : x(window).width() - (t.pageX - x(a).scrollLeft()) < s.scrollSensitivity && (n = x(a).scrollLeft(x(a).scrollLeft() + s.scrollSpeed)))),
    ...
    x.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(t, e, i) {
            for (var s, n, o, a, r, h, l, c, u, d = i.options, p = d.snapTolerance, f = e.offset.left, g = f + i.helperProportions.width, m = e.offset.top, _ = m + i.helperProportions.height, v = i.snapElements.length - 1; 0 <= v; v--)
                ...
                g < r - p || h + p < f || _ < l - p || c + p < m || !x.contains(i.snapElements[v].item.ownerDocument, i.snapElements[v].item) ? (i.snapElements[v].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, x.extend(i._uiHash(), {
                ...
                !i.snapElements[v].snapping && (s || n || o || a || u) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, x.extend(i._uiHash(), {
                    snapItem: i.snapElements[v].item
                })),
    ...
    x.ui.plugin.add("draggable", "stack", {
        start: function(t, e, i) {
            var s, n = i.options, o = x.makeArray(x(n.stack)).sort(function(t, e) {
                return (parseInt(x(t).css("zIndex"), 10) || 0) - (parseInt(x(e).css("zIndex"), 10) || 0)
            });
            o.length && (s = parseInt(x(o[0]).css("zIndex"), 10) || 0,
            x(o).each(function(t) {
    ...
    x.widget("ui.resizable", x.ui.mouse, {
        ...
        _mouseStart: function(t) {
            ...
            n.containment && (e += x(n.containment).scrollLeft() || 0,
        ...
        _mouseStop: function(t) {
            ...
            return this._helper && (s = (i = (e = this._proportionallyResizeElements).length && /textarea/i.test(e[0].nodeName)) && this._hasScroll(e[0], "left") ? 0 : l.sizeDiff.height,
            n = i ? 0 : l.sizeDiff.width,
            o = {
                width: l.helper.width() - n,
                height: l.helper.height() - s
            },
            a = parseFloat(l.element.css("left")) + (l.position.left - l.originalPosition.left) || null,
            r = parseFloat(l.element.css("top")) + (l.position.top - l.originalPosition.top) || null,
            h.animate || this.element.css(x.extend(o, {
                top: r,
                left: a
            })),
    ...
    x.ui.plugin.add("resizable", "containment", {
        start: function() {
            var i, s, t, e, n, o, a, r = x(this).resizable("instance"), h = r.options, l = r.element, c = h.containment, u = c instanceof x ? c.get(0) : /parent/.test(c) ? l.parent().get(0) : c;
            u && (r.containerElement = x(u),
        ...
        resize: function(t) {
            var e, i, s, n, o = x(this).resizable("instance"), a = o.options, r = o.containerOffset, h = o.position, l = o._aspectRatio || t.shiftKey, c = {
                top: 0,
                left: 0
            }, u = o.containerElement, d = !0;
            u[0] !== document && /static/.test(u.css("position")) && (c = r),
            h.left < (o._helper ? r.left : 0) && (o.size.width = o.size.width + (o._helper ? o.position.left - r.left : o.position.left - c.left),
            l && (o.size.height = o.size.width / o.aspectRatio,
            d = !1),
            o.position.left = a.helper ? r.left : 0),
            h.top < (o._helper ? r.top : 0) && (o.size.height = o.size.height + (o._helper ? o.position.top - r.top : o.position.top),
            ...
            s && n ? (o.offset.left = o.parentData.left + o.position.left,
    ...
    x.ui.plugin.add("resizable", "grid", {
        resize: function() {
            var t, e = x(this).resizable("instance"), i = e.options, s = e.size, n = e.originalSize, o = e.originalPosition, a = e.axis, r = "number" == typeof i.grid ? [i.grid, i.grid] : i.grid, h = r[0] || 1, l = r[1] || 1, c = Math.round((s.width - n.width) / h) * h, u = Math.round((s.height - n.height) / l) * l, d = n.width + c, p = n.height + u, f = i.maxWidth && i.maxWidth < d, g = i.maxHeight && i.maxHeight < p, m = i.minWidth && i.minWidth > d, _ = i.minHeight && i.minHeight > p;
            i.grid = r,
            m && (d += h),
            _ && (p += l),
            f && (d -= h),
    ...
    x.widget("ui.dialog", {
        ...
        _createButtons: function() {
            ...
            x.isEmptyObject(t) || x.isArray(t) && !t.length ? this._removeClass(this.uiDialog, "ui-dialog-buttons") : (x.each(t, function(t, e) {
                ...
                x("<button></button>", e).button(s).appendTo(n.uiButtonSet).on("click", function() {
    ...
    x.widget("ui.droppable", {
        ...
        _setOption: function(t, e) {
            ...
            : "scope" === t && (i = x.ui.ddmanager.droppables[this.options.scope],
            this._splice(i),
    ...
    !(x.ui.ddmanager = {
        ...
        prepareOffsets: function(t, e) {
            var i, s, n = x.ui.ddmanager.droppables[t.options.scope] || [], o = e ? e.type : null, a = (t.currentItem || t.element).find(":data(ui-droppable)").addBack();
        ...
        drag: function(o, a) {
            ...
            x.each(x.ui.ddmanager.droppables[o.options.scope] || [], function() {
                var t, e, i, s, n;
                this.options.disabled || this.greedyChild || !this.visible || (n = !(s = nt(o, this, this.options.tolerance, a)) && this.isover ? "isout" : s && !this.isover ? "isover" : null) && (this.options.greedy && (e = this.options.scope,
                (i = this.element.parents(":data(ui-droppable)").filter(function() {
                    return x(this).droppable("instance").options.scope === e
                })).length && ((t = x(i[0]).droppable("instance")).greedyChild = "isover" === n)),
    ...
    x.widget("ui.slider", x.ui.mouse, {
        ...
        _mouseCapture: function(t) {
            var e, i, s, n, o, a, r, h = this, l = this.options;
            ...
            this.handles.each(function(t) {
                ...
                (e < s || s === e && (t === h._lastChangedValue || h.values(t) === l.min)) && (s = e,
                n = x(this),
                o = t)
            }),
        ...
        _normValueFromMouse: function(t) {
            var e, i, s, n = "horizontal" === this.orientation ? (e = this.elementSize.width,
            t.x - this.elementOffset.left - (this._clickOffset ? this._clickOffset.left : 0)) : (e = this.elementSize.height,
            t.y - this.elementOffset.top - (this._clickOffset ? this._clickOffset.top : 0)), o = n / e;
            return 1 < o && (o = 1),
            o < 0 && (o = 0),
            "vertical" === this.orientation && (o = 1 - o),
            i = this._valueMax() - this._valueMin(),
            s = this._valueMin() + o * i,
    ...
    x.widget("ui.sortable", x.ui.mouse, {
        ...
        _mouseDrag: function(t) {
            ...
            !1 !== a && x.ui.ddmanager && !o.dropBehaviour && x.ui.ddmanager.prepareOffsets(this, t)),
            this.positionAbs = this._convertPositionTo("absolute"),
        ...
        _mouseStop: function(t, e) {
            var i, s, n, o;
            if (t)
                return x.ui.ddmanager && !this.options.dropBehaviour && x.ui.ddmanager.drop(this, t),
            ...
            if (r && t)
                for (e = r.length - 1; 0 <= e; e--)
                    for (i = (s = x(r[e], this.document[0])).length - 1; 0 <= i; i--)
                        (n = x.data(s[i], this.widgetFullName)) && n !== this && !n.options.disabled && a.push([x.isFunction(n.options.items) ? n.options.items.call(n.element) : x(n.options.items, n.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), n]);
            function h() {
                o.push(this)
            }
        ...
        _refreshItems: function(t) {
            ...
            var e, i, s, n, o, a, r, h, l = this.items, c = [[x.isFunction(this.options.items) ? this.options.items.call(this.element[0], t, {
                item: this.currentItem
            }) : x(this.options.items, this.element), this]], u = this._connectWith();
            if (u && this.ready)
                for (e = u.length - 1; 0 <= e; e--)
                    for (i = (s = x(u[e], this.document[0])).length - 1; 0 <= i; i--)
                        (n = x.data(s[i], this.widgetFullName)) && n !== this && !n.options.disabled && (c.push([x.isFunction(n.options.items) ? n.options.items.call(n.element[0], t, {
                            item: this.currentItem
        ...
        refreshPositions: function(t) {
            ...
            e = this.items.length - 1; 0 <= e; e--)
                (i = this.items[e]).instance !== this.currentContainer && this.currentContainer && i.item[0] !== this.currentItem[0] || (s = this.options.toleranceElement ? x(this.options.toleranceElement, i.item) : i.item,
        ...
        _createPlaceholder: function(i) {
            ...
            i.placeholder = x(n.placeholder.element.call(i.element, i.currentItem)),
        ...
        _contactContainers: function(t) {
            for (var e, i, s, n, o, a, r, h, l, c = null, u = null, d = this.containers.length - 1; 0 <= d; d--)
                if (!x.contains(this.currentItem[0], this.containers[d].element[0]))
                    if (this._intersectsWith(this.containers[d].containerCache)) {
                        if (c && x.contains(this.containers[d].element[0], c.element[0]))
                            continue;
                        c = this.containers[d],
                        u = d
                    } else
            ...
            if (c)
                if (1 === this.containers.length)
                    ...
                    l = h ? "pageX" : "pageY",
                    e = this.items.length - 1; 0 <= e; e--)
                        x.contains(this.containers[u].element[0], this.items[e].item[0]) && this.items[e].item[0] !== this.currentItem[0] && (a = this.items[e].item.offset()[n],
                        r = !1,
        ...
        _setContainment: function() {
            ...
            /^(document|window|parent)$/.test(s.containment) || (t = x(s.containment)[0],
        ...
        _generatePosition: function(t) {
            var e, i, s = this.options, n = t.pageX, o = t.pageY, a = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && x.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent, r = /(html|body)/i.test(a[0].tagName);
            ...
            s.grid && (e = this.originalPageY + Math.round((o - this.originalPageY) / s.grid[1]) * s.grid[1],
            o = !this.containment || e - this.offset.click.top >= this.containment[1] && e - this.offset.click.top <= this.containment[3] ? e : e - this.offset.click.top >= this.containment[1] ? e - s.grid[1] : e + s.grid[1],
            i = this.originalPageX + Math.round((n - this.originalPageX) / s.grid[0]) * s.grid[0],
            n = !this.containment || i - this.offset.click.left >= this.containment[0] && i - this.offset.click.left <= this.containment[2] ? i : i - this.offset.click.left >= this.containment[0] ? i - s.grid[0] : i + s.grid[0])),
            {
    ...
    x.widget("ui.spinner", {
        ...
        _adjustValue: function(t) {
            var e = this.options
              ...
              , s = t - i;
            return t = i + (s = Math.round(s / e.step) * e.step),
    ...
    x.widget("ui.tabs", {
        ...
        _create: function() {
            ...
            !1 !== this.options.active && this.anchors.length ? this.active = this._findActive(t.active) : this.active = x(),
            this._refresh(),
        ...
        _processTabs: function() {
            ...
            this.anchors.each(function(t, e) {
                ...
                s = h.element.find(h._sanitizeSelector(i))) : (i = "#" + (n = a.attr("aria-controls") || x({}).uniqueId()[0].id),
        ...
        _setOptionDisabled: function(t) {
            ...
            s = 0; i = this.tabs[s]; s++)
                e = x(i),
                !0 === t || -1 !== x.inArray(s, t) ? (e.attr("aria-disabled", "true"),
        ...
        _eventHandler: function(t) {
            ...
            t.preventDefault(),
            s.hasClass("ui-state-disabled") || s.hasClass("ui-tabs-loading") || this.running || n && !e.collapsible || !1 === this._trigger("beforeActivate", t, h) || (e.active = !o && this.tabs.index(s),
            this.active = n ? x() : s,
    ...
    x.widget("ui.tooltip", {
        ...
        _open: function(t, e, i) {
            ...
            this.liveRegion.children().hide(),
            (a = x("<div>").html(n.find(".ui-tooltip-content").html())).removeAttr("name").find("[name]").removeAttr("name"),
        ...
        _registerCloseHandlers: function(t, i) {
            var e = {
                keyup: function(t) {
                    var e;
                    t.keyCode === x.ui.keyCode.ESCAPE && ((e = x.Event(t)).currentTarget = i[0],
                    this.close(e, !0))
                }
            };
...
!function() {
    ...
    (DateFormatter = function(e) {
        ...
        getMonth: function(e) {
            var t, a = this;
            return 0 === (t = n(e, a.dateSettings.monthsShort) + 1) && (t = n(e, a.dateSettings.months) + 1),
            t
        },
            ...
            o = 0; o < r.length; o++)
                ...
                case "h":
                    ...
                    u > -1)
                        ...
                        s >= 1 && 12 >= s && l > -1 ? y.hour = s + l - 1 : s >= 0 && 23 >= s && (y.hour = s);
                    else {
                        if (!(s >= 0 && 23 >= s))
                            return null;
                        y.hour = s
        ...
        guessDate: function(e, t) {
            if ("string" != typeof e)
                return e;
            var a, n, r, o, i, s, d = this, u = e.replace(d.separators, "\0").split("\0"), l = /^[djmn]/g, f = t.match(d.validParts), c = new Date, m = 0;
            if (!l.test(f[0]))
                return e;
        ...
        formatDate: function(e, t) {
            ...
            if (e instanceof Date) {
                for (r = t.length,
                a = 0; r > a; a++)
                    "S" !== (i = t.charAt(a)) && "\\" !== i && (a > 0 && "\\" === t.charAt(a - 1) ? d += i : (o = s.parseFormat(i, e),
...
var datetimepickerFactory = function(e) {
    ...
    e.fn.datetimepicker = function(o, i) {
        var s, d, u = this, l = 48, f = 57, c = 96, m = 105, h = 17, g = 46, p = 13, y = 27, D = 8, v = 37, b = 38, k = 39, x = 40, T = 9, S = 116, w = 65, M = 67, O = 86, W = 90, _ = 89, F = !1, C = e.isPlainObject(o) || !o ? e.extend(!0, {}, a, o) : e.extend(!0, {}, a), P = 0, A = function(e) {
        ...
        return s = function(a) {
            function i() {
                var e, t = !1;
                return C.startDate ? t = Y.strToDate(C.startDate) : (t = C.value || (a && a.val && a.val() ? a.val() : "")) ? t = Y.strToDateTime(t) : C.defaultDate && (t = Y.strToDateTime(C.defaultDate),
                C.defaultTime && (e = Y.strtotime(C.defaultTime),
            ...
            function s(t) {
                ...
                a.on("keydown.xdsoft", function(i) {
                    ...
                    if (C >= l && C <= f || C >= c && C <= m || C === D || C === g) {
                        for (s = r(this),
                        d = C !== D && C !== g ? String.fromCharCode(c <= C && C <= m ? C - l : C) : "_",
                        C !== D && C !== g || !s || (s -= 1,
                        ...
                        "" === e.trim(u))
                            ...
                            !1;
                        for (s += C === D || C === g ? 0 : 1; /[^0-9_]/.test(t.mask.substr(s, 1)) && s < t.mask.length && s > 0; )
                            s += C === D || C === g ? -1 : 1;
                        n(t.mask, u) ? (this.value = u,
                        o(this, s)) : "" === e.trim(u) ? this.value = t.mask.replace(/[0-9]/g, "_") : a.trigger("error_input.xdsoft")
                    } else if (-1 !== [w, M, O, W, _].indexOf(C) && F || -1 !== [y, b, x, v, k, S, h, T, p].indexOf(C))
                        return !0;
                    return i.preventDefault(),
                    !1
                }))
            }
            var d, u, P, A, Y, j, H = e('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'), J = e('<div class="xdsoft_copyright"><a target="_blank" href="http://xdsoft.net/jqplugins/datetimepicker/">xdsoft.net</a></div>'), z = e('<div class="xdsoft_datepicker active"></div>'), I = e('<div class="xdsoft_monthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><div class="xdsoft_label xdsoft_month"><span></span><i></i></div><div class="xdsoft_label xdsoft_year"><span></span><i></i></div><button type="button" class="xdsoft_next"></button></div>'), N = e('<div class="xdsoft_calendar"></div>'), L = e('<div class="xdsoft_timepicker active"><button type="button" class="xdsoft_prev"></button><div class="xdsoft_time_box"></div><button type="button" class="xdsoft_next"></button></div>'), E = L.find(".xdsoft_time_box").eq(0), R = e('<div class="xdsoft_time_variant"></div>'), B = e('<button type="button" class="xdsoft_save_selected blue-gradient-button">Save Selected</button>'), V = e('<div class="xdsoft_select xdsoft_monthselect"><div></div></div>'), G = e('<div class="xdsoft_select xdsoft_yearselect"><div></div></div>'), U = !1, q = 0;
            C.id && H.attr("id", C.id),
            ...
            I.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function(t) {
                ...
                Y.currentTime && (o = Y.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()),
                r[s ? "hide" : "show"](),
                a = r.find("div.xdsoft_option"),
                n = 0; n < a.length && a.eq(n).data("value") !== o; n += 1)
                    i += a[0].offsetHeight;
                return r.xdsoftScroller(C, i / (r.children()[0].offsetHeight - r[0].clientHeight)),
                t.stopPropagation(),
                !1
            }),
            I.find(".xdsoft_select").xdsoftScroller(C).on("touchstart mousedown.xdsoft", function(e) {
                ...
                Y && Y.currentTime && Y.currentTime[e(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](e(this).data("value")),
                e(this).parent().parent().hide(),
                H.trigger("xchange.xdsoft"),
                C.onChangeMonth && e.isFunction(C.onChangeMonth) && C.onChangeMonth.call(H, Y.currentTime, H.data("input")),
                t !== Y.currentTime.getFullYear() && e.isFunction(C.onChangeYear) && C.onChangeYear.call(H, Y.currentTime, H.data("input"))
            }),
            H.getValue = function() {
            ...
            H.setOptions = function(r) {
                ...
                r.highlightedPeriods && e.isArray(r.highlightedPeriods) && r.highlightedPeriods.length && (o = e.extend(!0, [], C.highlightedDates),
                e.each(r.highlightedPeriods, function(a, r) {
                    ...
                    if (e.isArray(r))
                        ...
                        i = n.parseDate(m[0], C.formatDate),
                        s = n.parseDate(m[1], C.formatDate),
                        d = m[2],
                        c = m[3]
                    }
                    for (; i <= s; )
                        u = new t(i,d,c),
                        l = n.formatDate(i, C.formatDate),
                        i.setDate(i.getDate() + 1),
                        void 0 !== o[l] ? (f = o[l].desc) && f.length && u.desc && u.desc.length && (o[l].desc = f + "\n" + u.desc) : o[l] = u
                }),
                C.highlightedDates = e.extend(!0, [], o)),
                ...
                C.value && (Y.setCurrentTime(C.value),
                a && a.val && a.val(Y.str)),
            ...
            Y = new function() {
                ...
                t.now = function(e) {
                    ...
                    r.setDate(a.getDate())),
                    C.yearOffset && r.setFullYear(r.getFullYear() + C.yearOffset),
                    !e && C.defaultTime && (n = t.strtotime(C.defaultTime),
                ...
                t.nextMonth = function() {
                    ...
                    C.onChangeMonth && e.isFunction(C.onChangeMonth) && C.onChangeMonth.call(H, Y.currentTime, H.data("input")),
                    a !== t.currentTime.getFullYear() && e.isFunction(C.onChangeYear) && C.onChangeYear.call(H, Y.currentTime, H.data("input")),
                    H.trigger("xchange.xdsoft"),
                    n
                }
                ,
                ...
                t.strToDateTime = function(e) {
                    var a, r, o = [];
                    return e && e instanceof Date && t.isValidDate(e) ? e : ((o = /^([+-]{1})(.*)$/.exec(e)) && (o[2] = n.parseDate(o[2], C.formatDate)),
                    o && o[2] ? (a = o[2].getTime() - 6e4 * o[2].getTimezoneOffset(),
                    r = new Date(t.now(!0).getTime() + parseInt(o[1] + "1", 10) * a)) : r = e ? n.parseDate(e, C.format) : t.now(),
            ...
            I.find(".xdsoft_today_button").on("touchend mousedown.xdsoft", function() {
                ...
                n < (e = new Date(e.getFullYear(),e.getMonth(),e.getDate())) || (t = Y.strToDate(C.maxDate),
                n > (t = new Date(t.getFullYear(),t.getMonth(),t.getDate())) || (a.val(Y.str()),
                a.trigger("change"),
                H.trigger("close.xdsoft")))
            }),
            I.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function() {
                var t = e(this)
                  ...
                  , n = !1;
                !function e(r) {
                    t.hasClass(C.next) ? Y.nextMonth() : t.hasClass(C.prev) && Y.prevMonth(),
                    C.monthChangeSpinner && (n || (a = setTimeout(e, r || 100)))
                }(500),
            ...
            L.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function() {
                ...
                !function e(o) {
                    ...
                    t.hasClass(C.next) && s - i - C.timeHeightInTimePicker >= d ? R.css("marginTop", "-" + (d + C.timeHeightInTimePicker) + "px") : t.hasClass(C.prev) && d - C.timeHeightInTimePicker >= 0 && R.css("marginTop", "-" + (d - C.timeHeightInTimePicker) + "px"),
            ...
            H.on("xchange.xdsoft", function(t) {
                ...
                d = setTimeout(function() {
                    void 0 !== Y.currentTime && null !== Y.currentTime || (Y.currentTime = Y.now());
                    for (var t, i, s, d, u, l, f, c, m, h, g = "", p = new Date(Y.currentTime.getFullYear(),Y.currentTime.getMonth(),1,12,0,0), y = 0, D = Y.now(), v = !1, b = !1, k = !1, x = [], T = !0, S = ""; p.getDay() !== C.dayOfWeekStart; )
                    ...
                    for (g += "</tr></thead>",
                    g += "<tbody>",
                    !1 !== C.maxDate && (v = Y.strToDate(C.maxDate),
                    v = new Date(v.getFullYear(),v.getMonth(),v.getDate(),23,59,59,999)),
                    !1 !== C.minDate && (b = Y.strToDate(C.minDate),
                    b = new Date(b.getFullYear(),b.getMonth(),b.getDate())),
                    !1 !== C.minDateTime && (k = Y.strToDate(C.minDateTime),
                    k = new Date(k.getFullYear(),k.getMonth(),k.getDate(),k.getHours(),k.getMinutes(),k.getSeconds())); y < Y.currentTime.countDaysInMonth() || p.getDay() !== C.dayOfWeekStart || Y.currentTime.getMonth() === p.getMonth(); )
                        x = [],
                        y += 1,
                        s = p.getDay(),
                        d = p.getDate(),
                        ...
                        void 0 !== C.highlightedDates[n.formatDate(p, C.formatDate)] && (i = C.highlightedDates[n.formatDate(p, C.formatDate)],
                ...
                if (C.timepicker) {
                    ...
                    (a = R[0].offsetHeight) - t < (n = R.find(e).index() * C.timeHeightInTimePicker + 1) && (n = a - t),
                    E.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (a - t)])) : E.trigger("scroll_element.xdsoft_scroller", [0])
                }
            }),
            u = 0,
            N.on("touchend click.xdsoft", "td", function(t) {
                ...
                var n = e(this)
                  , r = Y.currentTime;
                if (void 0 !== r && null !== r || (Y.currentTime = Y.now(),
                r = Y.currentTime),
            ...
            R.on("touchend click.xdsoft", "div", function(t) {
                ...
                var a = e(this)
                  , n = Y.currentTime;
                if (void 0 !== n && null !== n || (Y.currentTime = Y.now(),
                n = Y.currentTime),
                a.hasClass("xdsoft_disabled"))
                    return !1;
                n.setHours(a.data("hour")),
                n.setMinutes(a.data("minute")),
                H.trigger("select.xdsoft", [n]),
                H.data("input").val(Y.str()),
                C.onSelectTime && e.isFunction(C.onSelectTime) && C.onSelectTime.call(H, Y.currentTime, H.data("input"), t),
                H.data("changed", !0),
                H.trigger("xchange.xdsoft"),
                H.trigger("changedatetime.xdsoft"),
                !0 !== C.inline && !0 === C.closeOnTimeSelect && H.trigger("close.xdsoft")
            }),
            z.on("mousewheel.xdsoft", function(e) {
                return !C.scrollMonth || (e.deltaY < 0 ? Y.nextMonth() : Y.prevMonth(),
                !1)
            }),
            ...
            H.on("changedatetime.xdsoft", function(t) {
                ...
                C.onGenerate && e.isFunction(C.onGenerate) && C.onGenerate.call(H, Y.currentTime, H.data("input")),
                U && (H.trigger("afterOpen.xdsoft"),
                U = !1)
            ...
            A = function() {
                ...
                s ? (o = "fixed",
                n + H.outerHeight() > c + m ? (l = "bottom",
                n = c + m - t.top) : n -= m) : n + H[0].offsetHeight > c + m && (n = t.top - H[0].offsetHeight + 1),
                n < 0 && (n = 0),
            ...
            H.on("open.xdsoft", function(t) {
                ...
                C.onClose && e.isFunction(C.onClose) && (a = C.onClose.call(H, Y.currentTime, H.data("input"), t)),
            ...
            H.setOptions(C),
            Y.setCurrentTime(i()),
            a.data("xdsoft_datetimepicker", H).on("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function() {
                a.is(":disabled") || a.data("xdsoft_datetimepicker").is(":visible") && C.closeOnInputClick || (clearTimeout(q),
                ...
                var a, n = t.which;
                return -1 !== [p].indexOf(n) && C.enterLikeTab ? (a = e("input:visible,textarea:visible,button:visible,a:visible"),
                H.trigger("close.xdsoft"),
                a.eq(a.index(this) + 1).focus(),
                !1) : -1 !== [T].indexOf(n) ? (H.trigger("close.xdsoft"),
                !0) : void 0
            ...
            if (t) {
                if ("string" === e.type(o))
                    ...
                    case "reset":
                        ...
                        this.value && t.data("xdsoft_datetime").isValidDate(n.parseDate(this.value, C.format)) || t.data("changed", !1),
...
!function(i) {
    ...
    r.prototype.getLeft = function(i) {
        ...
        s.slideCount % s.options.slidesToScroll != 0 && i + s.options.slidesToScroll > s.slideCount && s.slideCount > s.options.slidesToShow && (n = i > s.slideCount ? (s.slideOffset = (s.options.slidesToShow - (i - s.slideCount)) * s.slideWidth * -1,
    ...
    r.prototype.progressiveLazyLoad = function(i) {
        i = i || 1;
        var e, t, o, s = this, n = a("img[data-lazy]", s.$slider);
        n.length ? (e = n.first(),
        t = e.attr("data-lazy"),
    ...
    r.prototype.setSlideClasses = function(i) {
        ...
        !0 === s.options.infinite && (e <= i && i <= s.slideCount - 1 - e ? s.$slides.slice(i - e, i + e + 1).addClass("slick-active").attr("aria-hidden", "false") : (t = s.options.slidesToShow + i,
        n.slice(t - e + 1, t + e + 2).addClass("slick-active").attr("aria-hidden", "false")),
        ...
        t = !0 === s.options.infinite ? s.options.slidesToShow + i : i,
        s.options.slidesToShow == s.options.slidesToScroll && s.slideCount - i < s.options.slidesToShow ? n.slice(t - (s.options.slidesToShow - o), t + o).addClass("slick-active").attr("aria-hidden", "false") : n.slice(t, t + s.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false")),
    ...
    r.prototype.swipeMove = function(i) {
        var e, t, o, s, n = this, r = void 0 !== i.originalEvent ? i.originalEvent.touches : null;
        return !(!n.dragging || r && 1 !== r.length) && (e = n.getLeft(n.currentSlide),
        n.touchObject.curX = void 0 !== r ? r[0].pageX : i.clientX,
        n.touchObject.curY = void 0 !== r ? r[0].pageY : i.clientY,
        ...
        "vertical" !== (t = n.swipeDirection()) ? (void 0 !== i.originalEvent && 4 < n.touchObject.swipeLength && i.preventDefault(),
        ...
        (n.touchObject.edgeHit = !1) === n.options.infinite && (0 === n.currentSlide && "right" === t || n.currentSlide >= n.getDotCount() && "left" === t) && (o = n.touchObject.swipeLength * n.options.edgeFriction,
        n.touchObject.edgeHit = !0),
        !1 === n.options.vertical ? n.swipeLeft = e + o * s : n.swipeLeft = e + o * (n.$list.height() / n.listWidth) * s,
        !0 === n.options.verticalSwiping && (n.swipeLeft = e + o * s),
...
!function(r, a, s) {
    ...
    h.prototype = {
        ...
        init: function(t, i) {
            this.options = r.extend({}, this.defaults, i),
            this.inputNode = r(t),
            this.options.value = this.inputNode.val() || (this.options.isRange ? this.options.from + "," + this.options.from : "" + this.options.from),
            this.domNode = r(this.template),
            this.domNode.addClass(this.options.theme),
            this.inputNode.after(this.domNode),
            this.domNode.on("change", this.onChange),
            this.pointers = r(".pointer", this.domNode),
            this.lowPointer = this.pointers.first(),
            this.highPointer = this.pointers.last(),
            this.labels = r(".pointer-label", this.domNode),
            this.lowLabel = this.labels.first(),
            this.highLabel = this.labels.last(),
            this.scale = r(".scale", this.domNode),
            this.bar = r(".selected-bar", this.domNode),
        ...
        attachEvents: function() {
            this.clickableBar.click(r.proxy(this.barClicked, this)),
            this.pointers.on("mousedown touchstart", r.proxy(this.onDragStart, this)),
        ...
        onDragStart: function(t) {
            ...
            r(s).on("mousemove.slider touchmove.slider", r.proxy(this.onDrag, this, i)),
            r(s).on("mouseup.slider touchend.slider touchcancel.slider", r.proxy(this.onDragEnd, this)))
        },
        onDrag: function(t, i) {
            i.stopPropagation(),
            i.preventDefault(),
        ...
        barClicked: function(t) {
            ...
            l = (a = Math.abs(s - i + o)) == (h = Math.abs(e - i + n)) ? i < s ? this.pointers.first() : this.pointers.last() : a < h ? this.pointers.first() : this.pointers.last(),
        ...
        setValue: function(t) {
            ...
            this.isSingle() || this.setPosition(this.lowPointer, s[0]),
        ...
        renderScale: function() {
            ...
            this.scale.html(s),
            r("ins", this.scale).each(function() {
                r(this).css({
        ...
        showPointerValue: function(t, i, s) {
            var o, e, n = r(".pointer-label", this.domNode)[t.hasClass("low") ? "first" : "last"](), a = this.positionToValue(i);
            e = r.isFunction(this.options.format) ? (o = this.isSingle() ? void 0 : t.hasClass("low") ? "low" : "high",
            this.options.format(a, o)) : this.options.format.replace("%s", a);
        ...
        positionToValue: function(t) {
            ...
            if (this.isDecimal()) {
                ...
                if (0 !== s)
                    for (-1 === (s = "" + s).indexOf(".") && (s += "."); s.length - s.indexOf(".") < 3; )
                        s += "0";
                else
                    s = "0.00";
                return s
    ...
    r.fn[l] = function(o) {
        ...
        return this.each(function() {
            var t = r(this)
              ...
              , s = "object" == typeof o && o;
            i || (t.data("plugin_" + l, i = new h(this,s)),
            r(a).resize(function() {
...
$(function() {
    ...
    onSelect: function(dateText) {
        $("#LToTime").html("");
        $("#LToTime").append('<option value="">Please Select</option>');
        GetNewFromTimeOptions(dateText);
    }
...
}), $(".profileMenu li a").filter(function() {
    return this.href == location.href.replace(/#.*/, "");
}).closest("li").children("a").addClass("active"), $('.ita input[id=DrivingLicenceImageFile]').change(function() {
    var mainValue = $(this).val();
    if (mainValue == "") {
        document.getElementById("placeholder-text").innerHTML = "Attach relevant documents";
    } else {
        document.getElementById("placeholder-text").innerHTML = mainValue.replace("C:\\fakepath\\", "");
    }
}), $('.ita input[id=EmiratesIdImageFile]').change(function() {
    var mainValue = $(this).val();
    if (mainValue == "") {
        document.getElementById("placeholder-text2").innerHTML = "Attach relevant documents";
    } else {
        document.getElementById("placeholder-text2").innerHTML = mainValue.replace("C:\\fakepath\\", "");
    }
}), $('.ita input[id=ImageFile]').change(function() {
    var mainValue = $(this).val();
    if (mainValue == "") {
        document.getElementById("placeholder-text3").innerHTML = "Attach relevant documents";
    } else {
        document.getElementById("placeholder-text3").innerHTML = mainValue.replace("C:\\fakepath\\", "");
    }
}), $('#editDrivingLicenceFile').change(function() {
    var mainValue = $(this).val();
    if (mainValue == "") {
        $("#editDrivingLicencePlaceholder").attr("placeholder", "Attach relevant documents");
    } else {
        $("#editDrivingLicencePlaceholder").attr("placeholder", mainValue.replace("C:\\fakepath\\", ""));
    }
}), $('#editEmirateIdFile').change(function() {
    var mainValue = $(this).val();
    if (mainValue == "") {
        $("#editEmirateIdPlaceholder").attr("placeholder", "Attach relevant documents");
    } else {
        $("#editEmirateIdPlaceholder").attr("placeholder", mainValue.replace("C:\\fakepath\\", ""));
    }
}), $('#editUserFile').change(function() {
    var mainValue = $(this).val();
    if (mainValue == "") {
        $("#editUserPlaceholder").attr("placeholder", "Attach relevant documents");
    } else {
        $("#editUserPlaceholder").attr("placeholder", mainValue.replace("C:\\fakepath\\", ""));
    }
})),
...
$(".videobtn").click(function(e) {
    ...
    $(".vedioWrap .loaders").fadeIn(),
    $(".vimeo-wrapper").html('<video autoplay muted loop><source src="/Assets/video/Myride.mov" type="video/mp4"></video>'),
    $(".vimeo-wrapper").fadeIn()
}),
$("#accordion .acrdBtn").click(function(e) {
    e.preventDefault(),
    $("#accordion .acrdBtn").removeClass("ui-state-active"),
    $(this).addClass("ui-state-active"),
    $("#accordion .acrdContent").slideUp("slow"),
    $(this).next(".acrdContent").slideDown("slow")
}),
$("#accordion_faqs .acrdBtn").click(function(e) {
    e.preventDefault(),
    $("#accordion_faqs .acrdBtn").removeClass("ui-state-active"),
    $(this).addClass("ui-state-active"),
    $("#accordion_faqs .acrdContent").slideUp("slow"),
    $(this).next(".acrdContent").slideDown("slow")
}),
$(".smallImages").slick({
    slidesToShow: 4,
...
$(".sortBtn .leftSide").click(function(e) {
    e.preventDefault(),
    $(".sideBar").addClass("activeSideBar")
}),
$(".sideBar .closeSideBar").click(function(e) {
    e.preventDefault(),
          ...
          , o = function() {
            ...
            (e = [{
                ...
                value: function(t, e, i) {
                    e.length > this.countryCodeMaxLen && (this.countryCodeMaxLen = e.length),
                    ...
                    for (var n = 0; n < this.countryCodes[e].length; n++)
                        if (this.countryCodes[e][n] === t)
                            return;
                    var o = i !== c ? i : this.countryCodes[e].length;
                ...
                value: function() {
                    ...
                    var e, i, n, o = this._createEl("div", {
                        class: t
                    });
                    ...
                    !(i = this.telInput.getAttribute("name")) || -1 !== (n = i.lastIndexOf("[")) && (e = "".concat(i.substr(0, n), "[").concat(e, "]")),
                ...
                value: function(t, e, i) {
                    for (var n = "", o = 0; o < t.length; o++) {
                        var a = t[o]
                          , s = i ? "-preferred" : "";
                        n += "<li class='iti__country ".concat(e, "' tabIndex='-1' id='iti-").concat(this.id, "__item-").concat(a.iso2).concat(s, "' role='option' data-dial-code='").concat(a.dialCode, "' data-country-code='").concat(a.iso2, "'>"),
                        n += "<div class='iti__flag-box'><div class='iti__flag iti__".concat(a.iso2, "'></div></div>"),
                        n += "<span class='iti__country-name'>".concat(a.name, "</span>"),
                        n += "<span class='iti__dial-code'>+".concat(a.dialCode, "</span>"),
                        n += "</li>"
                    }
                ...
                value: function() {
                    ...
                    e && !i ? this._updateFlagFromNumber(t) : "auto" !== o && (o ? this._setFlag(o.toLowerCase()) : e && i ? this._setFlag("us") : (this.defaultCountry = this.preferredCountries.length ? this.preferredCountries[0].iso2 : this.countries[0].iso2,
                    t || this._setFlag(this.defaultCountry)),
                    t || a || s || r || (this.telInput.value = "+".concat(this.selectedCountryData.dialCode))),
                ...
                value: function() {
                    ...
                    o = i + this.telInput.offsetHeight + n < e + window.innerHeight,
                    a = e < i - n,
                    this._toggleClass(this.countryList, "iti__country-list--dropup", !o && a),
                    this.options.dropdownContainer && (s = !o && a ? 0 : this.telInput.offsetHeight,
                    this.dropdown.style.top = "".concat(i + s, "px"),
                    this.dropdown.style.left = "".concat(t.left + document.body.scrollLeft, "px"),
                    this._handleWindowScroll = function() {
                        return r._closeDropdown()
                    }
                    ,
                ...
                value: function() {
                    ...
                    this._handleKeydownOnDropdown = function(t) {
                        t.preventDefault(),
                        "ArrowUp" === t.key || "Up" === t.key || "ArrowDown" === t.key || "Down" === t.key ? i._handleUpDownKey(t.key) : "Enter" === t.key ? i._handleEnterKey() : "Escape" === t.key ? i._closeDropdown() : /^[a-zA-ZÀ-ÿа-яА-Я ]$/.test(t.key) && (n && clearTimeout(n),
                        e += t.key.toLowerCase(),
                        i._searchForCountry(e),
                ...
                value: function(t) {
                    var e, i, n, o, a, s = t;
                    this.options.formatOnDisplay && window.intlTelInputUtils && this.selectedCountryData && (e = !this.options.separateDialCode && (this.options.nationalMode || "+" !== s.charAt(0)),
                    n = (i = intlTelInputUtils.numberFormat).NATIONAL,
                    o = i.INTERNATIONAL,
                    a = e ? n : o,
                    s = intlTelInputUtils.formatNumber(s, this.selectedCountryData.iso2, a)),
                ...
                value: function(t) {
                    var e = t
                      ...
                      , n = "1" === i;
                    e && this.options.nationalMode && n && "+" !== e.charAt(0) && ("1" !== e.charAt(0) && (e = "1".concat(e)),
                    e = "+".concat(e)),
                    ...
                    if (o) {
                        ...
                        if (!("1" === i && this._isRegionlessNanp(a)) && !l)
                        ...
                        "+" === e.charAt(0) && a.length ? s = "" : e && "+" !== e || (s = this.defaultCountry);
                ...
                value: function(t) {
                    ...
                    var i, n, o, a, s = t ? "".concat(this.selectedCountryData.name, ": +").concat(this.selectedCountryData.dialCode) : "Unknown";
                    return this.selectedFlag.setAttribute("title", s),
                    ...
                    this.options.allowDropdown && ((o = this.activeItem) && (o.classList.remove("iti__active"),
                    o.setAttribute("aria-selected", "false")),
                    t && ((a = this.countryList.querySelector("#iti-".concat(this.id, "__item-").concat(t, "-preferred")) || this.countryList.querySelector("#iti-".concat(this.id, "__item-").concat(t))).setAttribute("aria-selected", "true"),
                ...
                value: function() {
                    var t, e, i = "aggressive" === this.options.autoPlaceholder || !this.hadInitialPlaceholder && "polite" === this.options.autoPlaceholder;
                    window.intlTelInputUtils && i && (t = intlTelInputUtils.numberType[this.options.placeholderNumberType],
                ...
                key: "_scrollTo",
                value: function(t, e) {
                    var i, n = this.countryList, o = window.pageYOffset || document.documentElement.scrollTop, a = n.offsetHeight, s = n.getBoundingClientRect().top + o, r = s + a, l = t.offsetHeight, u = t.getBoundingClientRect().top + o, d = u + l, h = u - s + n.scrollTop, c = a / 2 - l / 2;
                    u < s ? (e && (h -= c),
                    n.scrollTop = h) : r < d && (e && (h += c),
                    i = a - l,
                    n.scrollTop = h - i)
                }
            }, {
                ...
                value: function() {
                    var t = this.telInput.value.trim()
                      ...
                      , n = this.options.separateDialCode && "+" !== t.charAt(0) && e && i ? "+".concat(e) : "";
                    return n + t
                }
            }, {
                ...
                value: function(t) {
                    var e, i, n = t;
                    return !this.options.separateDialCode || (e = this._getDialCode(n)) && (i = " " === n[(e = "+".concat(this.selectedCountryData.dialCode)).length] || "-" === n[e.length] ? e.length + 1 : e.length,
                    n = n.substr(i)),
                    this._cap(n)
                }
            }, {
